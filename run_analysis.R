...
x_test1 <- cbind(y_test,test_or_train0,x_test)
x_train1 <- cbind(y_train,test_or_train1,x_train)
...
mean_of_data <- aggregate(mean_n_std[,-1],list(mean_n_std$activity_type),mean)
